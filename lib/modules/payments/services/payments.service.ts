...
import {
  ...
  QuickBooksPayments,
  QuickBooksPaymentsDeleteResponseModel,
...
export class QuickBooksPaymentsService {
  ...
  public forCompany(realm: string): QuickBooksCompanyPaymentsService {
    return new QuickBooksCompanyPaymentsService(
      realm,
      this.authService,
      this.http,
    );
...
> {
  ...
  public create(
    dto: CreateQuickBooksPaymentsDto,
  ...
  public fullUpdate(
    id: string,
    token: string,
    dto: FullUpdateQuickBooksPaymentsDto,
  ): Observable<QuickBooksPaymentsResponseModel>;
  public fullUpdate(
  ...
  public fullUpdate(
    ...args: [
      string | QuickBooksPayments,
      string | FullUpdateQuickBooksPaymentsDto,
      FullUpdateQuickBooksPaymentsDto?,
    ]
  ): Observable<QuickBooksPaymentsResponseModel> {
    const [id, token, dto] =
      QuickBooksCompanyPaymentsService.getUpdateArguments(args);
    return this.post({
      ...dto,
      Id: id,
      SyncToken: token,
  ...
  public delete(
    id: string,
    token: string,
  ): Observable<QuickBooksPaymentsDeleteResponseModel>;
  public delete(
    invoice: QuickBooksPayments,
  ): Observable<QuickBooksPaymentsDeleteResponseModel>;
  public delete(
    ...args: [string | QuickBooksPayments, string?]
  ): Observable<QuickBooksPaymentsDeleteResponseModel> {
    const [id, token] =
      QuickBooksCompanyPaymentsService.getOperationArguments(args);
    return this.post(
      {
        Id: id,
        SyncToken: token,
  ...
  private static getUpdateArguments<DTO>(
    args: [string | QuickBooksPayments, string | DTO, DTO?],
  ): [string, string, DTO] {
