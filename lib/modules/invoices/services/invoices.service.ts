...
import {
  CreateQuickBooksInvoicesDto,
  FullUpdateQuickBooksInvoicesDto,
  SparseUpdateQuickBooksInvoicesDto,
} from '..';
import {
...
export class QuickBooksInvoicesService {
  ...
  public forCompany(realm: string): QuickBooksCompanyInvoicesService {
    return new QuickBooksCompanyInvoicesService(
      realm,
      this.authService,
      this.http,
    );
...
> {
  ...
  public create(
    dto: CreateQuickBooksInvoicesDto,
  ...
  public fullUpdate(
    id: string,
    token: string,
    dto: FullUpdateQuickBooksInvoicesDto,
  ): Observable<QuickBooksInvoicesResponseModel>;
  public fullUpdate(
  ...
  public fullUpdate(
    ...args: [
      string | QuickBooksInvoices,
      string | FullUpdateQuickBooksInvoicesDto,
      FullUpdateQuickBooksInvoicesDto?,
    ]
  ): Observable<QuickBooksInvoicesResponseModel> {
    const [id, token, dto] =
      QuickBooksCompanyInvoicesService.getUpdateArguments(args);
    return this.post({
      ...dto,
      Id: id,
      SyncToken: token,
  ...
  public sparseUpdate(
    id: string,
    token: string,
    dto: SparseUpdateQuickBooksInvoicesDto,
  ): Observable<QuickBooksInvoicesResponseModel>;
  public sparseUpdate(
    invoice: QuickBooksInvoices,
    dto: SparseUpdateQuickBooksInvoicesDto,
  ...
  public sparseUpdate(
    ...args: [
      string | QuickBooksInvoices,
      string | SparseUpdateQuickBooksInvoicesDto,
      SparseUpdateQuickBooksInvoicesDto?,
    ]
  ): Observable<QuickBooksInvoicesResponseModel> {
    const [id, token, dto] =
  ...
  public delete(
    id: string,
    token: string,
  ): Observable<QuickBooksInvoicesDeleteResponseModel>;
  public delete(
    invoice: QuickBooksInvoices,
  ): Observable<QuickBooksInvoicesDeleteResponseModel>;
  public delete(
    ...args: [string | QuickBooksInvoices, string?]
  ): Observable<QuickBooksInvoicesDeleteResponseModel> {
    const [id, token] =
      QuickBooksCompanyInvoicesService.getOperationArguments(args);
    return this.post(
      {
        Id: id,
        SyncToken: token,
  ...
  private static getUpdateArguments<DTO>(
    args: [string | QuickBooksInvoices, string | DTO, DTO?],
  ): [string, string, DTO] {
