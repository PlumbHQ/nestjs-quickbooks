...
export interface QuickBooksInvoicesResponseModel
  extends QuickBooksResponseModel {
  Invoice: QuickBooksInvoices;
}

export interface QuickBooksInvoicesQueryResponseModel
  extends QuickBooksResponseModel {
...
export interface QuickBooksInvoicesDeleteResponseModel
  extends QuickBooksResponseModel {
