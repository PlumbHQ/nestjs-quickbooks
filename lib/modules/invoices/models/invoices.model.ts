...
export interface QuickBooksInvoiceSalesItemLineModel
  extends QuickBooksBaseInvoiceLinesModel {
...
export interface QuickBooksInvoiceGroupLineModel
  extends QuickBooksBaseInvoiceLinesModel {
...
export interface QuickBooksInvoiceDescriptionOnlyLineModel
  extends QuickBooksBaseInvoiceLinesModel {
...
export interface QuickBooksInvoiceDiscountLineModel
  extends QuickBooksBaseInvoiceLinesModel {
...
export interface QuickBooksInvoiceSubTotalLineModel
  extends QuickBooksBaseInvoiceLinesModel {
